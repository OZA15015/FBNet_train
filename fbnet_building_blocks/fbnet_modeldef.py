...
MODEL_ARCH = {
    ...
    "1123test1-2-7": {
            "block_op_type": [
            ["ir_k3_e3"], 
            ["ir_k5_e6"], ["ir_k3_e1"], ["ir_k5_e6"], ["skip"], 
            ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k5_e6"], ["skip"], 
            ["ir_k5_e3"], ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["skip"], ["skip"], 
            ["skip"], ["skip"], ["ir_k5_e3"], ["ir_k5_e6"], 
            ["ir_k5_e6"], 
            ],
            "block_cfg": {
                "first": [16, 1],
                "stages": [
                    ...
                    [[6, 32, 1, 2]],  [[6, 32, 1, 1]],      [[6, 32, 1, 1]],  [[1, 32, 1, 1]],  # stage 3
                    [[3, 64, 1, 2]],  [[6, 64, 1, 1]],      [[1, 64, 1, 1]],  [[1, 64, 1, 1]],  # stage 4
                    [[6, 96, 1, 1]], [[1, 96, 1, 1]],     [[1, 96, 1, 1]], [[1, 96, 1, 1]], # stage 5
