...
MODEL_ARCH = {
    ...
    "1123test1": {
            ...
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], ["skip"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k3_e3"], ["ir_k5_e1"], 
            ["ir_k5_e6"], ["ir_k5_e3"], ["ir_k3_e1"], ["ir_k3_e3"], 
            ["skip"], 
            ],
            "block_cfg": {
                "first": [16, 1],
                "stages": [
                    ...
                    [[6, 32, 1, 2]],  [[6, 32, 1, 1]],      [[6, 32, 1, 1]],  [[6, 32, 1, 1]],  # stage 3
                    [[6, 64, 1, 2]],  [[6, 64, 1, 1]],      [[6, 64, 1, 1]],  [[1, 64, 1, 1]],  # stage 4
                    [[6, 96, 1, 1]], [[6, 96, 1, 1]],     [[3, 96, 1, 1]], [[1, 96, 1, 1]], # stage 5
                    [[6, 160, 1, 2]], [[3, 160, 1, 1]],     [[1, 160, 1, 1]], [[3, 160, 1, 1]], # stage 6
                    [[1, 320, 1, 1]],                                                       # stage 7
                ],
                "backbone": [num for num in range(23)],
            },
    ...
    "1123test1-3-19": {
            "block_op_type": [
            ["ir_k3_e6"], 
            ["ir_k5_e6"], ["skip"], ["ir_k3_e6"], ["ir_k3_e6"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k5_e3"], 
            ["ir_k3_e6"], ["ir_k5_e6"], ["skip"], ["skip"], 
            ["ir_k3_e6"], ["skip"], ["skip"], ["ir_k3_e3"], 
            ["ir_k5_e1"], 
            ],
            "block_cfg": {
                "first": [16, 1],
    ...
    "1123test1-2-12": {
            "block_op_type": [
            ["ir_k3_e6"], 
            ["ir_k3_e6"], ["ir_k3_e6"], ["ir_k5_e6"], ["ir_k5_e3"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e6"], 
            ["ir_k5_e6"], ["ir_k5_e6"], ["ir_k5_e3"], ["skip"], 
            ["ir_k5_e6"], ["skip"], ["skip"], ["skip"], 
            ["skip"], ["skip"], ["ir_k3_e3"], ["ir_k5_e6"], 
            ["ir_k5_e6"], 
            ],
            "block_cfg": {
                "first": [16, 1],
                "stages": [
                    ...
                    [[6, 64, 1, 2]],  [[6, 64, 1, 1]],      [[3, 64, 1, 1]],  [[1, 64, 1, 1]],  # stage 4
                    [[6, 96, 1, 1]], [[1, 96, 1, 1]],     [[1, 96, 1, 1]], [[1, 96, 1, 1]], # stage 5
                    [[1, 160, 1, 2]], [[1, 160, 1, 1]],     [[3, 160, 1, 1]], [[6, 160, 1, 1]], # stage 6
                    [[6, 320, 1, 1]],                                                       # stage 7
                ],
                "backbone": [num for num in range(23)],
            },
